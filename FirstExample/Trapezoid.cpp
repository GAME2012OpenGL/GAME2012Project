...
void Trapezoid::CreateMesh()
{
	GLfloat Trapezoid_vertices[] =
	{
		...
		2.f,0.f,1.f,		0.95,0,		0,0,0,
		2.f,4.f,1.f,		0.95,1,		0,0,0,
		0.f,3.f,1.f,		0,0.75,		0,0,0,

		2.f,0.f,1.f,		0,0,		0,0,0,
		2.f,0.f,0.f,		0.95,0,		0,0,0,
		2.f,4.f,0.f,		0.95,1,		0,0,0,
		2.f,4.f,1.f,		0,0.75,		0,0,0,

		
		0.f,0.f,1.f,		0,0,		0,0,0,
		0.f,0.f,0.f,		0.95,0,		0,0,0,
		2.f,0.f,0.f,		0.95,1,		0,0,0,
		2.f,0.f,1.f,		0,0.75,		0,0,0,

		
		0.f,0.f,0.f,		0,0,		0,0,0,
		0.f,0.f,1.f,		0.95,0,		0,0,0,
		0.f,3.f,1.f,		0.95,1,		0,0,0,
		0.f,3.f,0.f,		0,0.75,		0,0,0,

		
		0.f,3.f,0.f,		0,0,		0,0,0,
		0.f,3.f,1.f,		0.95,0,		0,0,0,
		2.f,4.f,1.f,		0.95,1,		0,0,0,
		2.f,4.f,0.f,		0,0.75,		0,0,0,

		
		2.f,0.f,0.f,		0,0,		0,0,0,
		0.f,0.f,0.f,		0.95,0,		0,0,0,
		0.f,3.f,0.f,		0.95,0.75,		0,0,0,
